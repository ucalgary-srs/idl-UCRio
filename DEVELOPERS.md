...
1. Increment the version number and change the date in `idlpackage.json`, `ucrio_version.pro`, and `README.md`.
2. Generate a new distributable Zip file ([more info](https://www.l3harrisgeospatial.com/docs/ipm.html#CREATE))

    ```idl
    IDL> ipm,/create,'path_to_code',name='idl-ucrio'
    ```

3. Upload the generated Zip file to data.phys.ucalgary.ca, and update the symlink for latest.zip
