...
pro ucrio_example_using_proxies
  ; ------------------------
  ; Using IDL-UCRio with a proxy connection
  ; ------------------------
  ;
  ; Some networks require you to utilize a proxy connection to access the internet. To
  ; help facilitate usage of IDL-UCRio for this situation, we have a few helper procedures
  ...
  ;
  ; ucrio_set_proxy, 'localhost', 9000, username='testing', password='something'
