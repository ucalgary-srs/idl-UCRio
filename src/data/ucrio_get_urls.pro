...
;       site/device. This function is used by the ucrio_download() function.
;
; :Parameters:
...
;
; :Examples:
;       u = ucrio_get_urls('NORSTAR_RIOMETER_K2_TXT', '2022-01-01T00:00', '2022-01-01T23:59', site_uid='chur')
;       u = ucrio_get_urls('SWAN_HSR_K0_H5', '2025-01-01T00:00', '2025-01-01T00:00')
;+
function ucrio_get_urls, dataset_name, start_ts, end_ts, site_uid = site_uid, device_uid = device_uid
  ; set required params
