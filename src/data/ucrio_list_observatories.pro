...
;         the instrument array. Possible values are 'norstar_riometer' and 'swan_hsr'.
;
; :Keywords:
...
;       observatories = ucrio_list_observatories('swan_hsr', uid='mean')
;+
function ucrio_list_observatories, instrument_array, uid = uid
  ; set params
